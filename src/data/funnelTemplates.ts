  ...
  phases: [
    {
      ...
      tasks: [
        ...
        { title: 'Crear Lead Magnet (ebook/checklist/guía)', responsibleRole: 'copywriter', dayStart: 1, dayEnd: 5, output: 'PDF entregable', priority: 'P1' },
        ...
        { title: 'Crear secuencia de emails bienvenida (5 emails)', responsibleRole: 'copywriter', dayStart: 4, dayEnd: 8, output: 'secuencia activa en plataforma email' },
        ...
        { title: 'Grabar 10 anuncios tipo reels para captación', responsibleRole: 'designer', dayStart: 5, dayEnd: 10, output: '10 videos editados' },
    ...
    },
    {
      ...
      tasks: [
        ...
        { title: 'Configurar secuencia calentamiento WhatsApp (7 días)', responsibleRole: 'copywriter', dayStart: 15, dayEnd: 16, output: '7 mensajes programados' },
        { title: 'Crear secuencia correos electrónicos calentamiento (4 emails)', responsibleRole: 'copywriter', dayStart: 15, dayEnd: 16, output: 'secuencia activa' },
        ...
        { title: 'Crear material Ensayo/Webinar (presentación + guión)', responsibleRole: 'copywriter', dayStart: 20, dayEnd: 25, output: 'deck aprobado', priority: 'P1' },
      ],
    },
    {
      ...
      tasks: [
        ...
        { title: 'Activar secuencias mensajes ventas WhatsApp (5 días)', responsibleRole: 'community', dayStart: 30, dayEnd: 35, output: 'secuencias activas' },
    ...
    },
    {
      ...
      dayEnd: 45,
      tasks: [
        { title: 'Secuencia email urgencia + escasez (3 emails)', responsibleRole: 'copywriter', dayStart: 33, dayEnd: 37, output: '3 emails enviados' },
        ...
        { title: 'Reunión de cierre con cliente + ROPRE actualizado', responsibleRole: 'strategist', dayStart: 45, dayEnd: 45, output: 'ROPRE actualizado + próximos pasos', priority: 'P1' },
      ],
    },
  ],
};
  ...
  phases: [
    {
      ...
      tasks: [
        ...
        { title: 'Grabar reels/posts/carruseles/historias para orgánico (10 piezas)', responsibleRole: 'designer', dayStart: 3, dayEnd: 12, output: '10 piezas publicadas' },
        { title: 'Crear 5 anuncios de venta tipo video VSL corto', responsibleRole: 'copywriter', dayStart: 5, dayEnd: 12, output: '5 videos aprobados' },
    ...
    },
    {
      ...
      tasks: [
        ...
        { title: 'Crear secuencia bienvenida + expectativa (11 mensajes WhatsApp)', responsibleRole: 'copywriter', dayStart: 14, dayEnd: 15, output: 'secuencia programada' },
        ...
        { title: 'Activar secuencia mensajes venta (5 días post-taller)', responsibleRole: 'copywriter', dayStart: 30, dayEnd: 35, output: 'mensajes enviados' },
      ],
    },
    {
  ...
  phases: [
    {
      ...
      tasks: [
        ...
        { title: 'Plan de contenido de activación (3 semanas)', responsibleRole: 'strategist', dayStart: 1, dayEnd: 5, output: 'calendario aprobado' },
        { title: 'Crear 12 reels de valor + educación (3 por semana)', responsibleRole: 'editor', dayStart: 5, dayEnd: 26, output: 'reels publicados', recurring: true },
    ...
    },
    {
      ...
      dayEnd: 25,
      tasks: [
        { title: 'Crear Lead Magnet para captar emails/WA', responsibleRole: 'copywriter', dayStart: 5, dayEnd: 10, output: 'lead magnet listo' },
        ...
        { title: 'Crear secuencia email calentamiento (5 emails)', responsibleRole: 'copywriter', dayStart: 10, dayEnd: 12, output: 'secuencia activa' },
      ],
    },
    {
      ...
      tasks: [
        ...
        { title: 'Secuencia WhatsApp post-evento (5 días)', responsibleRole: 'community', dayStart: 30, dayEnd: 35, output: 'mensajes enviados' },
  ...
  phases: [
    {
      ...
      tasks: [
        ...
        { title: 'Configurar secuencia email nurturing (5 pasos)', responsibleRole: 'copywriter', dayStart: 7, dayEnd: 14, output: 'secuencia activa' },
