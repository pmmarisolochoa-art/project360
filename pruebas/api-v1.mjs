...
await build({
  entryPoints: {
    ...
    clients: join(aqui, '../api/v1/clients/index.ts'),
    team: join(aqui, '../api/v1/team/index.ts'),
    ropre: join(aqui, '../api/v1/ropre/index.ts'),
    deliverables: join(aqui, '../api/v1/deliverables/index.ts'),
  },
  bundle: true,
  format: 'esm',
  platform: 'neutral',
